...
| 8.3 | **Acquisition AI ("get customers"):** `app/api/outreach` — per-lead AI: classify intent/fit + draft a personalised outreach DM; surface "Draft message" on the Find-tenants cards (fallback = template) | Claude | ⬜ | makes acquisition feel AI-driven; tool-use+Zod+fallback |
